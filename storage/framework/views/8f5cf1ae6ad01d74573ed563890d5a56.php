...
<div class="character-gallery">
    <h1><?php echo e($character->name); ?>'s Gallery</h1>
    <form action="<?php echo e(url('/characters/'. $character->id .'/gallery/store')); ?>" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
            ...
            <div class="gallery-items">
                <?php $__currentLoopData = $galleryItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="gallery-item">
                        ...
                        <form action="<?php echo e(route('gallery.destroy', ['id' => $item->id])); ?>" method="POST" class="delete-form">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\María\Desktop\proyectitos\meggify\resources\views/character_gallery.blade.php ENDPATH**/ ?>