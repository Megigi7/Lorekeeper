        ...
        <?php $__currentLoopData = $relationships; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relationship): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li>
                <a href="<?php echo e(url('relationships/' . $relationship->id)); ?>">
                        <?php echo e($relationship->character2->name); ?> & <?php echo e($relationship->character1->name); ?>
...
<?php echo $__env->make('layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\María\Desktop\proyectitos\meggify\resources\views/relationship_all.blade.php ENDPATH**/ ?>